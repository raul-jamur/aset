...
<form id="form" name="form" method="post" action="<?php echo site_url('fasilitas/mod'); ?>">
    ...
    <table width="400" border="0" cellpadding="2" cellspacing="0" class="central">
        <tr>
            ...
            <td><input type="text" name="fasilitas_nama" id="fasilitas_nama" maxlength="50" class="inputan validate[required]" value="<?=$fasilitas[0]->fasilitas_nama; ?>"/></td>
        </tr>
        <tr>
